...
class CompilerGUI:
    ...
    def create_widgets(self):
        ...
        self.compile_btn = ttk.Button(self.control_frame, text="Compile (F5)", command=self.compile)
        self.run_btn = ttk.Button(self.control_frame, text="Run (F6)", command=self.run)
        self.clear_btn = ttk.Button(self.control_frame, text="Clear All", command=self.clear)
    ...
    def compile(self):
        ...
        # Update status
        if not (self.lexer.errors or self.parser.errors or self.semantic.errors):
